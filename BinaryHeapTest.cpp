...
bool test_basic(int numItems) {
  ...
  // 1   2
  MinBinaryHeap h;
  BinaryHeapNode * n0 = new BinaryHeapNode(0, new IntegerData(0));
  BinaryHeapNode * n1 = new BinaryHeapNode(1, new IntegerData(1));
  BinaryHeapNode * n2 = new BinaryHeapNode(2, new IntegerData(2));
